// Private headers used by AlwaysAlive — edit if iOS version differs
...
+ (void)activateShortcut:(id)item withBundleIdentifier:(NSString *)bundle forIconView:(id)iconView;
@end
...
- (void)updateSettings:(id)settings withTransitionContext:(id)ctx completion:(id)comp;
@end
